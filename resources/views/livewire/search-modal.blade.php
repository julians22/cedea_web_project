<div x-data="{ fullscreenModal: false }" @keydown.escape="fullscreenModal=false">
    ...
    <template x-teleport="body">
        ...
        <div class="fixed inset-0 z-[99] flex h-screen w-screen bg-white"
            ...
            x-transition:enter-end="translate-y-100" x-transition:leave="transition ease-in duration-300"
            x-transition:leave-start="translate-y-1000" x-transition:leave-end="-translate-y-full">
            <button
