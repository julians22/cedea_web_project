...
<div class="relative aspect-video overflow-hidden" x-data="{
    ...
    <video class="relative h-full w-full bg-black object-cover" preload="none" x-ref="player"
        @loadedmetadata="metaDataLoaded" @ended="videoEnded" :loop="loop" autoplay muted preload="metadata"
        :poster="poster" crossorigin="anonymous">
