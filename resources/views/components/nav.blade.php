<nav class="relative z-20 w-full bg-cedea-red px-4 py-8 text-white lg:px-2" x-data="{ openNav: false, hoverPosition: null }">
    <div class="container relative mx-auto grid grid-cols-2 justify-between gap-4 lg:flex">
        {{-- ? logo --}}
        <a class="-mt-8 block h-14 w-28 shadow-xl shadow-black/50 lg:-mb-20 lg:h-auto lg:w-40" href="{{ route('home') }}">
            <x-logo />
        </a>
