<div class="grid content-center items-center sm:relative" x-data="{ seachModalOpen: false }" @keydown.escape="seachModalOpen=false"
    ...
    <form
        class="md:min-w-28 min-h-8 has-[:focus]:border-cedea-red-500/50 has-[:active]:border-cedea-red-500/5has-[:focus]:border-cedea-red-500/50 absolute right-4 top-full z-10 flex max-w-[90dvw] translate-y-[150%] items-center justify-between gap-x-4 rounded-full border bg-white px-4 py-2 outline-cedea-red-500 navbar-small:translate-y-1/2 md:right-0 lg:translate-y-full"
        ...
        <input class="p-0.5 text-cedea-red-500 outline-none placeholder:text-cedea-red-500/50 max-sm:w-full"
            id="query" name="query" type="text" placeholder="Cari di sini">
