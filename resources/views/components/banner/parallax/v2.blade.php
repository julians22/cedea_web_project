...
<div class="h-full max-h-full bg-white">
    <div class="h-full max-h-full bg-cover bg-no-repeat">
        <div class="relative mx-auto grid h-full max-h-full max-w-[145rem] grid-cols-2 px-8">
                    ...
                    <div class="atropos-rotate">
                        ...
                        <div class="atropos-inner overflow-visible">
                            <div class="relative h-full p-4">
                                ...
                                <img class="absolute left-[55%] top-1/2 h-3/5 max-h-full w-auto -translate-x-full -translate-y-1/2 -rotate-12 drop-shadow-2xl"
